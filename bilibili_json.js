...
if (url.includes("app.bilibili.com/x/v2/splash/")) {
    ...
    i.data.tab = [
        ...
        { id: 151, name: "影视", tab_id: "film", uri: "bilibili://pgc/cinema-tab", pos: 3 },
    ...
    let i = JSON.parse($response.body);
    i.data?.vip && !i.data.vip.status && (i.data.vip.type = 2, i.data.vip.status = 1, i.data.vip.vip_pay_type = 1, i.data.vip.due_date = 466982416e4);
    body = JSON.stringify(i);
    ...
    let i = JSON.parse($response.body);
    i.data && (i.data.activity_banner_info = void 0, i.data.shopping_info = { is_show: 0 });
    body = JSON.stringify(i);
